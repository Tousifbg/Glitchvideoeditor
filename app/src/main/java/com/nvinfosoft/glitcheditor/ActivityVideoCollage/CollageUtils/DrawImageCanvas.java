package com.nvinfosoft.glitcheditor.ActivityVideoCollage.CollageUtils;
    ...
    public Bitmap drawCanvas() {
        ...
        for (int i3 = 0; i3 < CollageUtils.clgstickerviewsList.size(); i3++) {
            try {
                ...
                com.nvinfosoft.glitcheditor.ActivityVideoCollage.CollageBitmapUtils.CollageUtils.width = collageSingleFingerView.getImageWidth();
                ...
                if (bitmapDrawable.getBitmap() != null) {
                    try {
                        ...
                        Bitmap createScaledBitmap = Bitmap.createScaledBitmap(bitmap, com.nvinfosoft.glitcheditor.ActivityVideoCollage.CollageBitmapUtils.CollageUtils.width, imageHeight, true);
