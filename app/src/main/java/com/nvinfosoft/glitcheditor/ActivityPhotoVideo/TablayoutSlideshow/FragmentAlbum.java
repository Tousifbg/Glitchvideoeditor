package com.nvinfosoft.glitcheditor.ActivityPhotoVideo.TablayoutSlideshow;
...
import com.nvinfosoft.glitcheditor.ActivityPhotoVideo.ActivityDisplayAlbum;
import com.nvinfosoft.glitcheditor.ActivityPhotoVideo.ModelSlideshow.Album;
import com.nvinfosoft.glitcheditor.ActivityPhotoVideo.ModelSlideshow.Gallery;
import com.nvinfosoft.glitcheditor.ActivityPhotoVideo.ModelSlideshow.ImageSelection;
import com.nvinfosoft.glitcheditor.ActivityPhotoVideo.ModelSlideshow.SelectBucketImage;
import com.nvinfosoft.glitcheditor.ActivityPhotoVideo.UtilsSlideshow.PreferenceManager;
import com.nvinfosoft.glitcheditor.ActivityPhotoVideo.UtilsSlideshow.Utils;
...
public class FragmentAlbum extends Fragment {
    ...
    public class RecyclerGallaryAlbumAdapter extends Adapter<RecyclerGallaryAlbumAdapter.holder> {
        ...
        public void onBindViewHolder(holder aVar, final int i) {
            ...
            Picasso.with(getContext()).load(this.a.get(i).imgUri.toString()).into(aVar.imageView);
        ...
        public holder onCreateViewHolder(ViewGroup viewGroup, int i) {
            return new holder(LayoutInflater.from(getContext()).inflate(R.layout.slideshow_row_list_gallary, viewGroup, false));
        }
    }
    ...
    class a extends AsyncTask<Void, Void, String> {
        ...
        public void onPostExecute(String str) {
            ...
            FragmentAlbum.this.recyclerGallaryAlbumAdapter = new RecyclerGallaryAlbumAdapter(FragmentAlbum.context,
                    FragmentAlbum.this.galleries, FragmentAlbum.this.instance);
    ...
    public void functionToRun(int i2) {
        Intent intent = new Intent(getContext(), ActivityDisplayAlbum.class);
