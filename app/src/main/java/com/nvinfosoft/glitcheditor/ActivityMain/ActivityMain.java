package com.nvinfosoft.glitcheditor.ActivityMain;
...
import com.nvinfosoft.glitcheditor.ActivityVideoMusicList.ActivityVideoMusicList;
...
public class ActivityMain extends AppCompatActivity {
    ...
    public void videojoin(View view) {
        ...
        final Intent intent = new Intent(this, com.nvinfosoft.glitcheditor.ActivityVideoJoiner.ActivityVideoList.class);
        intent.setFlags(67108864);
        if (mInterstitialAd != null && mInterstitialAd.isLoaded()) {
            mInterstitialAd.show();
            mInterstitialAd.setAdListener(new AdListener() {
    ...
    public void videotoimg(View view) {
        ...
        final Intent intent = new Intent(this, com.nvinfosoft.glitcheditor.ActivityVideoGIF.ActivityVideoList.class);
        intent.setFlags(67108864);
        if (mInterstitialAd != null && mInterstitialAd.isLoaded()) {
            mInterstitialAd.show();
            mInterstitialAd.setAdListener(new AdListener() {
